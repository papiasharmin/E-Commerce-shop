...
export const getStaticPaths: GetStaticPaths= async()=> {
  return {
    paths: [{ params: { bagid: "women leather shoulder bag luxary" } }, { params: { bagid: "women leather shoulder bag elegant" } }],
...
export const getStaticProps: GetStaticProps= async(context) =>{
  ...
  const bag = await db.collection("bag").findOne({gender:'female',name:context.params?.bagid});
