...
const AllJackets: React.FC<{alljackets:string}> = (props) => {
  ...
  //         <p>PRODUCT NO FOUND, ADJUST FILTER</p>
  //       </div>
  //     </div>
  //   )
  // }
...
export const getStaticProps = async() =>{
  ...
  const alljackets = await db.collection("jacket").find({gender:'female'}).project({img:1,name:1,size:1,price:1,totalrating:1,_id:0}).toArray();
